...
class MpesaController extends Controller
{
    ...
    public function customerMpesaSTKPush()
    {
        ...
        $approval_details = DB::table('approval_details')->select('name','paybill','money')->get();
        ...
        $curl_post_data = [
            ...
            'Amount' => ($approval_details -> 'money'),
            'PartyA' => 254728736229, // replace this with your phone number
            'PartyB' => ($approval_details -> 'paybill'),
            'PhoneNumber' => 254728736229, // replace this with your phone number
    ...
    {
        $consumer_key="w9pr48AJFuL3X6XVR5UmqWzMHEUIGiiO";
        $consumer_secret="UGW8OHsMGhXESXOF";
